...
<button onChange={nextPage} type="button" className="btn btn-info mr-1">&laquo; Anterior</button>

<button onChange={previousPage} type="button" className="btn btn-info mr-1">Siguiente &raquo;</button>
